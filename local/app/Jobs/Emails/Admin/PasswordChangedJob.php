...
namespace App\Jobs\Emails\Admin;
...
class PasswordChangedJob implements ShouldQueue
{
    ...
    public function handle()
    {
        try {
            ...
            $subject = \Lang::choice('emails.admin.XXXXXXX', null, [], $locale);

            \App\Jobs\SendEmailJob::dispatch('admin.XXXXXXX', $subject, $email, $emailArr);
        } catch (\Exception $e) {
            \Log::error($e);
        } finally {
            return true;
