...
class BookingRefundCompleteJob implements ShouldQueue
{
    ...
    public function handle()
    {
        try {
            ...
            $subject = \Lang::choice('emails.user.refund_credited', null, compact('booking_code'), $locale);

            \App\Jobs\SendEmailJob::dispatch('user.refund_credited', $subject, $email, $emailArr);
        } catch (\Exception $e) {
            \Log::error($e);
        } finally {
            return true;
