...
class DisputeRaisedJob implements ShouldQueue
{
    ...
    public function handle()
    {
        try {
            ...
            $subject = \Lang::choice('emails.user.dispute_raised', null, compact('booking_code'), $locale);

            \App\Jobs\SendEmailJob::dispatch('user.dispute_raised', $subject, $email, $emailArr);
        } catch (\Exception $e) {
            \Log::error($e);
        } finally {
            return true;
