...
@section('title') {{ transLang('create_booking_questions') }} @endsection
...
@section('content')
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active">{{ transLang('create_booking_questions') }}</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{ transLang('create_booking_questions') }}</h3>
                    </div>
                    <div class="box-body">
        ...
        jQuery(function($) {
            $(document).on('click','#createBtn', function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    dataType: 'json',
                    url: "{{ route('admin.booking_questions.create') }}",
