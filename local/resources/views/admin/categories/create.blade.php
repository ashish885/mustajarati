...
@section('title') {{ transLang('create_category') }} @endsection
...
@section('content')
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active">{{ transLang('create_category') }}</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{ transLang('create_category') }}</h3>
                    </div>
                    <div class="box-body">
                        ...
                        <form id="save-frm" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="ar_name" placeholder="{{ transLang('ar_name') }}">
                                </div>
                            </div>
                            <div class="form-group">
