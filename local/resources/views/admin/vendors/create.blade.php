...
@section('title') {{ transLang('create_vendors') }} @endsection
...
<section class="content-header">
    <ol class="breadcrumb">
        ...
        <li class="active">{{ transLang('create_vendors') }}</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h2 class="box-title">{{ transLang('create_vendors') }}</h2>
                </div>
                <div class="box-body">
                    ...
                    <form id="save-frm" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="password" placeholder="{{ transLang('password') }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label required">{{ transLang('national_id') }}</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="national_id" placeholder="{{ transLang('national_id') }}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="bank_code" placeholder="{{ transLang('bank_code') }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label required">{{ transLang('account_no') }}</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="account_no" placeholder="{{ transLang('account_no') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="account_holder_name" placeholder="{{ transLang('account_holder_name') }}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group image-wrapper">
                            <label class="col-sm-3 control-label required">{{ transLang('national_id_image') }}</label>
                            <div class="col-sm-6">
