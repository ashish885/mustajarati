        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li>  <a href="{{ route('website.categories') }}" class="link-btn">تصنيفات السلع التأجيرية</a></li>
              <li> <a href="{{ route('website.contact_us') }}" class="link-btn">تواصل معنا</a></li>
            </ul>
                ...
                <div class="row flex-row header-row desktop-nav">
                    ...
                    <div class="col-md-6">
                        <a class="btn lang-switch-btn pull-right" href="{{ route('website.change.locale', $switcherLocale) }}">{{ $switcherLocale == 'ar' ? 'Arabic' : 'English' }}</a>
                        <a href="{{ route('website.contact_us') }}" class="link-btn">تواصل معنا</a>
                        <a href="{{ route('website.categories') }}" class="link-btn">تصنيفات السلع التأجيرية</a>
                    </div>
                </div>
                ...
                <div class="row flex-row p-50">
                    <div class="col-md-6">
                        <div class="header-text-box" data-aos="zoom-in">
                            <p class="mt-box">مُستأجراتي</p>
                            <p class="primary-text">معاً، نمتلك كل شيء!</p>
                            <h1 class="secondry-bold-text">مُستأجراتي | وفّر ، أجّر ، واستثمر</h1>
